...
export default function Form2() {
  ...
  return (
    <form onSubmit={handleSubmit} id='initial-form' className='w-full montserrat h-full rounded flex items-center justify-center text-white relative'>
      <div id='first-form-container' className='absolute bottom-[-120%] z-[3] w-[40%] h-[450%] bg-[#00113c] border-[1px] border-blue-600 rounded-[1em] flex flex-col justify-center items-center'>
