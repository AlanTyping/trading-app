  ...
  return (
    ...
    items-center justify-center absolute inset-x-0 bottom-[0%] top-[-43%] bg-[#061333] z-[5]'>
      ...
      <div id="delete-all-button-container" className='h-[50%] w-[60%] flex flex-row justify-center items-start justify-around'>
        <button className='confirmation-button h-[48%] w-[30%] border-[1px] text-[1.10rem] flex items-center justify-center hover:cursor-pointer bg-[#ff000069] rounded hover:bg-[#ff00007d] border-red-600' onClick={handleYes}>Yes</button>
        <button className='confirmation-button h-[48%] w-[30%] border-[1px] text-[1.10rem] flex items-center justify-center border-blue-600 rounded bg-[#002e93] hover:bg-[#0047e1]' onClick={handleNo}>No</button>
      </div>
    </div>
  )
}
