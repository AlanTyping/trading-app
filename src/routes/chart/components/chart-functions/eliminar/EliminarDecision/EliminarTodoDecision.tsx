...
export default function EliminarTodoDecision() {
    ...
    return (
        <div 
        id='delete-files'
        className='h-[40%] mb-[10px] celu-button-width celu-font-size w-[60%] min-w-[100px] text-[1.15rem] hover:cursor-pointer bg-[#ff000069] rounded hover:bg-[#ff00007d] border-[1px] border-red-600 flex justify-center 
